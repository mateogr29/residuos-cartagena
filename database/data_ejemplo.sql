...
INSERT INTO rutas_recoleccion (operador_id, estado, fecha_asignacion, hora_estimada, zonas_cobertura, ubicacion_inicio, ubicacion_fin, fecha_finalizacion) VALUES
(3, 'en_proceso', datetime('now'), '08:00', 'Bazurto - Centro', 'Carrera 1', 'Carrera 10', datetime('now', '+4 hours')),
(3, 'asignada', datetime('now'), '10:00', 'San Diego - Getsemaní', 'Carrera 5', 'Carrera 15', datetime('now', '+6 hours')),
(4, 'completada', datetime('now', '-1 day'), '07:00', 'Centro - Bazurto', 'Carrera 2', 'Carrera 8', datetime('now', '-1 day', '+4 hours')),
(8, 'asignada', datetime('now'), '14:00', 'Pedregal - Arborizadora', 'Carrera 20', 'Carrera 30', datetime('now', '+6 hours'));
